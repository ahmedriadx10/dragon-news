...
import { handleRegister } from "@/server-acitons/formAction";
...
<h6 className="text-(--dark-2) text-2xl md:text-4xl font-semibold text-center border-b border-zinc-300 pb-10">Register Your account</h6>
     <Form
...
action={handleRegister}
    >
      ...
      >
        <Label className="text-(--dark-2) text-xl font-semibold">Your Name</Label>
     <Input placeholder="Enter your name" className=' shadow-none p-4.5 bg-[#F3F3F3] rounded-lg placeholder:text-(--dark-4) placeholder:text-[16px]'/>
        <FieldError />
      </TextField>
      <TextField
        isRequired
      ...
      >
        <Label className="text-(--dark-2) text-xl font-semibold">Photo URL</Label>
